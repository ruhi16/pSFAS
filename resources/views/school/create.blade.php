		...
		<div class="panel panel-default">
			...
			{!! Form::open(['method'=>'POST',   'route'=>['schools.store'], 'class'=>'form-horizontal']) !!}
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="name" id="name" placeholder="School Name">
					</div>
				</div>
				<div class="form-group">
					<label for="dise" class="col-sm-2 control-label">DISE CODE</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" name="dise" id="dise" placeholder="School DISE Code">
					</div>
				</div>
				<div class="form-group">
					<label for="vill" class="col-sm-2 control-label">Village</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" name="vill" id="vill" placeholder="Village">
					</div>
					<label for="post" class="col-sm-2 control-label">Post Office</label>
					<div class="col-sm-4">
						<input type="text" class="form-control" name="post" id="post" placeholder="Post Office">
					</div>
				</div>
				<div class="form-group">
					<label for="pstn" class="col-sm-2 control-label">Police Station</label>
					<div class="col-sm-3">
						<input type="text" class="form-control" name="pstn" id="pstn" placeholder="Police Station">
					</div>
					...
					<div class="col-sm-2">
						<input type="text" class="form-control" name="pin" id="dist" placeholder="Pin Number">
					</div>
				</div>
